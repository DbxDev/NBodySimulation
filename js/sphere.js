...
Sphere.prototype.Draw = function(context){
	...
	context.drawImage(this.hiddenCanvas , normalizedXDistance(this.x)-normalizedXDistance(this.radius),normalizedYDistance(this.y)-normalizedYDistance(this.radius));
